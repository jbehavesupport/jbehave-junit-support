...
import org.jbehavesupport.engine.story.GivenStoryBeforeScenarioStories
...
class GivenStoryBeforeScenarioStoriesTest extends Specification {

    def "Test correct notifications"() {
        given:
        EngineTestKit.Builder builder = EngineTestKit.engine("jbehave")
            .enableImplicitConfigurationParameters(true)
            .selectors(selectClass(GivenStoryBeforeScenarioStories))
        ...
        executionResults.allEvents()
            .assertEventsMatchExactly(
                ...
                event(container(GivenStoryBeforeScenarioStories), started()),
                ...
                event(container(GivenStoryBeforeScenarioStories), finishedSuccessfully()),
    ...
    def "Test descriptions"() {
        ...
        then:
        desc.displayName == "GivenStoryBeforeScenarioStories"
        children.size() == 3
