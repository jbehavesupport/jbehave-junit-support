...
import org.jbehavesupport.engine.story.FailInGivenStories
...
class FailInGivenStoryTest extends Specification {
    ...
    def "Test correct notifications"() {
        EngineTestKit.Builder builder = EngineTestKit.engine("jbehave")
            ...
            .selectors(selectClass(FailInGivenStories))
        ...
        executionResults.allEvents()
            .assertEventsMatchExactly(
                ...
                event(container(FailInGivenStories), started()),
                event(test("BeforeStories"), started()),
                event(test("BeforeStories"), finishedSuccessfully()),
                event(container("Story: FailInGivenStory"), started()),
                event(container("Scenario: Given story test"), started()),
                event(test("FailInGivenStory"), started()),
                event(test("FailInGivenStory"), finishedWithFailure()),
                event(test("FailInGivenStory"), finishedSuccessfully()),
                ...
                event(container("Story: FailInGivenStory"), finishedSuccessfully()),
                event(test("AfterStories"), started()),
                event(test("AfterStories"), finishedSuccessfully()),
                event(container(FailInGivenStories), finishedSuccessfully()),
    ...
    def "Test descriptions"() {
        ...
        then:
        desc.displayName == "FailInGivenStories"
        children.size() == 3
